...
recipes.addShaped("tinker_table_5", <mysticalagradditions:tinkering_table>, [[<mysticalagriculture:soulstone:3>, <mysticalagriculture:soulstone:3>, <mysticalagriculture:soulstone:3>], [<mysticalagradditions:storage>, <futuremc:smithing_table>, <mysticalagradditions:storage>], [<mysticalagradditions:storage>, null, <mysticalagradditions:storage>]]);
