...
mods.thaumicrestoration.CrystalInfusion.addRecipe("hueInfusedThaumiumCrafting", <contenttweaker:hue_infused_thaumium>, "tinctura", <thaumicrestoration:item_ingot:4>);
...
mods.thaumicrestoration.CrystalInfusion.addRecipe("bismuthCrafting2", <planarartifice:bismuth_ingot>, "auram", <contenttweaker:hue_infused_thaumium>);
