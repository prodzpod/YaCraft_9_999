...
recipes.addShaped("new_altar3", <bewitchment:obsidian_witches_altar>, [[<bewitchment:empty_jar>, <contenttweaker:inert_aethoria_dust>, <bewitchment:empty_jar>], [<ore:obsidian>, <bewitchment:elder_wood>, <ore:obsidian>], [<ore:obsidian>, <bewitchment:elder_wood>, <ore:obsidian>]]);
recipes.addShaped("new_altar4", <bewitchment:coquina_witches_altar>, [[<bewitchment:empty_jar>, <contenttweaker:inert_aethoria_dust>, <bewitchment:empty_jar>], [<ore:coquina>, <bewitchment:elder_wood>, <ore:coquina>], [<ore:coquina>, <bewitchment:elder_wood>, <ore:coquina>]]);
recipes.addShaped("new_altar5", <bewitchment:embittered_brick_witches_altar>, [[<bewitchment:empty_jar>, <contenttweaker:inert_aethoria_dust>, <bewitchment:empty_jar>], [<bewitchment:embittered_bricks>, <bewitchment:elder_wood>, <bewitchment:embittered_bricks>], [<bewitchment:embittered_bricks>, <bewitchment:elder_wood>, <bewitchment:embittered_bricks>]]);
recipes.addShaped("new_altar6", <bewitchment:scorned_brick_witches_altar>, [[<bewitchment:empty_jar>, <contenttweaker:inert_aethoria_dust>, <bewitchment:empty_jar>], [<bewitchment:scorned_bricks>, <bewitchment:elder_wood>, <bewitchment:scorned_bricks>], [<bewitchment:scorned_bricks>, <bewitchment:elder_wood>, <bewitchment:scorned_bricks>]]);
